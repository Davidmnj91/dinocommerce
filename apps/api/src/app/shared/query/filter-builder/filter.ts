...
const buildWhere = <Entity extends object>(qb: QueryBuilder<Entity>, filtersExpression?: FilterExpression<Entity>) => {
  ...
  return qb.where(buildExpressionRecursive(filtersExpression), Object.values(params));
};
